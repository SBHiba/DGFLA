report 50007 "DGF Leverage effect Overview"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/Rep50007-Leverage effect Overview.rdlc';
    Caption = 'Leverage effect Overview', Comment = 'Tableau Effet de levier';
    ...
    labels
    {
        ReportTitle = 'Occupancy rate of lawyers (partners and associates) by Partner', Comment = 'Taux d''occupation des avocats (associés et collab.) par associé';
        PageCaption = 'Page';
        Period = 'Period:';
