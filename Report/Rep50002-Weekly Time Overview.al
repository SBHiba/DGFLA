report 50002 "DGF Weekly Time Overview"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/Rep50002-Weekly Time Overview.rdlc';

    Caption = 'Weekly Time Overview', Comment = 'Récapitulatif Heures hebdo.';
    ...
    dataset
    {
        dataitem(Resource; Resource)
        {
            ...
            dataitem(DateTable; Date)
            {
                ...
                begin
                    DateTable.SetRange("Period Start", DateStartingPeriod_g);
                end;
            ...
            begin
                ...
                RecDate.SetRange("Period Start", CalcDate('<-CY>', DateStartingPeriod_g), DateStartingPeriod_g);
                            ...
                            case oDisplayCalendar_g of
                                oDisplayCalendar_g::Week:
                                    begin
                                        ...
                                        DateStartingPeriod_g := CalcDate('<-CW-1W>', CurrDateStartingPeriod);
                                        DateEndingPeriod_g := CalcDate('<CW-1W>', CurrDateStartingPeriod);
                                    end;
                            end;
                        end;
                    }
    ...
    labels
    {
        ReportTitle = 'Weekly Time Overview', Comment = 'FRA = Récapitulatif Heures hebdo.';
        PageCaption = 'Page';
    ...
    begin
        ...
        DateStartingPeriod_g := CalcDate('<-CW-1W>', WorkDate);
        DateEndingPeriod_g := CalcDate('<CW-1W>', WorkDate);
    ...
    var
        ...
        CurrDateStartingPeriod, CurrDateEndingPeriod, DateEndingPeriod_g, DateStartingPeriod_g, MinDate4Cumul, MinDateYear : Date;
