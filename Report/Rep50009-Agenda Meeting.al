report 50009 "DGF Agenda Meeting"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/Rep50009-Agenda Meeting.rdlc';

    Caption = 'Weekly Associate Agenda Meeting', Comment = 'Réunion Agenda Collab.';
    ...
    dataset
    {
        dataitem(Resource; Resource)
        {
            ...
            begin
                ...
                ResCardHyperlink := GetUrl(CurrentClientType, CompanyName, ObjectType::"Page", Page::"Resource Card", Resource_L, true);
